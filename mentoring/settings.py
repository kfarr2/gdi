...
MEDIA_URL = variable('MEDIA_URL', '/media/')
...
MIDDLEWARE_CLASSES = (
    ...
    #'django.middleware.transaction.TransactionMiddleware',     Django 1.6+ uses atomic requests
    'mentoring.middleware.LoggingMiddleware',
